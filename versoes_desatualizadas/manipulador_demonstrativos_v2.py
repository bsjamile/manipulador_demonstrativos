...
- Ao mover os arquivos, eles serão organizados em subpastas baseadas no estado (BA, PE, RN, NEOS, BSB).
...
class Ui_Demonstrativos(object):
        ...
        for estado in estados:
            ...
            if os.path.exists(folder_remove_demonstrativo):
                for file_to_remove in os.listdir(folder_remove_demonstrativo):
                    ...
                    if 'DEMONSTRATIVO' in file_to_remove_upper or 'CASHSTATEMENT' in file_to_remove_upper:
    ...
    def mover(self):
        ...
        arquivos_downloads = [
            ...
            if 'DEMONSTRATIVO' in file_name.upper() or 'CASHSTATEMENT' in file_name.upper()  # Verifica as palavras corretamente
        ]
        ...
        for file_path in arquivos_downloads_full_path:
            if int(os.path.getmtime(file_path)) // (24 * 3600) == data_mais_recente:
                ...
                if 'BA' in file_path:
                    ...
                    estado = 'NEOS'
                elif 'FACEB' in file_path:
                    estado = 'BSB'  # Considera PGA como NEOS também
    ...
    def renomear(self):
        ...
        lista_nomes = [       
            ...
            f'DEMONSTRATIVODECAIXA_FACEBBD_{data_demonstrativo}.pdf',
            f'DEMONSTRATIVODECAIXA_FACEBBDSALD_{data_demonstrativo}.pdf',
            f'DEMONSTRATIVODECAIXA_FACEBCD_{data_demonstrativo}.pdf',
            f'DEMONSTRATIVODECAIXA_FACEBPGA_{data_demonstrativo}.pdf',
            f'DEMONSTRATIVODECAIXA_FACEBSAUDE_{data_demonstrativo}.pdf'
        ]
        ...
        for estado in estados:
            ...
            if os.path.exists(pasta_demonstrativos):
                ...
                arquivos_demonstrativos = [
                    f for f in os.listdir(pasta_demonstrativos) if 'DEMONSTRATIVO' in f.upper() or 'CASHSTATEMENT' in f.upper()
                ]
